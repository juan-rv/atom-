...
const MAQUINAS = [
  {
    id: "centro_001",
    nombre: "Centro de mecanizado 001",
    codigo: "AT-MI-001",
    ...
    operaciones: [
      {
        id: "taladrado",
        nombre: "Taladrado",
        herramientas: ["Brocas HSS"],
      },
      {
        id: "alessado",
        nombre: "Alessado",
        herramientas: ["Escariadores"],
      },
      {
        id: "desbaste",
        nombre: "Desbaste",
  ...
  {
    id: "centro_002",
    nombre: "Centro de mecanizado 002",
    codigo: "AT-MI-002",
    tipo: "centro_mecanizado",
    operaciones: [
      {
  ...
  {
    id: "centro_003",
    nombre: "Centro de mecanizado 003",
    codigo: "AT-MI-003",
    tipo: "centro_mecanizado",
    operaciones: [
      {
...

  {
    ...
    operaciones: [
      ...
      },
      {
        id: "roscado",
        nombre: "Roscado",
        herramientas: ["Inserto R0,1"],
      },
      {
        id: "grafilado",
        nombre: "Grafilado",
        herramientas: ["Grafiladora"],
      },
      {
        id: "desbaste",
        nombre: "Desbaste",
        herramientas: ["Inserto R0,5"],
      },
      {
        id: "acabado",
        nombre: "Acabado",
  ...
  {
    id: "torno_convencional_001",
    nombre: "Torno Convencional 001",
    codigo: "AT-MI-006",
...
function IngenieriaProcesos({
  ...
  */
  ...
  /*
  ===================================================
  DIMENSIÓN EN BRUTO HEREDADA DEL 3.1
  ===================================================
  */

  const dimensionEnBruto = useMemo(() => {

    const forma =
      datosFormato31.formaSuministro || "";

    const dimensiones =
      datosFormato31.dimensiones || {};
  ...
  */
  ...
  /*
  ===================================================
  CAMBIAR CANTIDAD DE OPERACIONES
  ===================================================
  */
        ...
        <section className="formato31-section">
          ...
          <div className="formato31-grid">
            ...
            <div className="formato31-field">
              ...
              <input
                value={
                  datosFormato31.cantidad ?? datosFormato31.qty ?? ""
                }
                readOnly
              />
